...
const DivSite2 = function() {
    ...
    if(loading) {
        return <img className='image_loading2' src={Loading} alt="loading" />
    }else {
        return (
        ...
        <>
            <div className='div_site_box'>
                ...
                <div className='div_site_box_ii'>
                    <img className='div_site_box_ii_big_image' src={user.avatar} alt={user.first_name + 's avatar'} width={867} height={280}/>
                </div>
                <div>
                    <img className='div_site_box_ii_image' src={user.avatar} alt="Bobur_photo" width={150} height={150}/>
                </div>
                ...
                <div className='div_site_main_section div_site_box_border'>
                    <div className='div_site_main_section_box'>
                        <a className='div_site_main_section_link_lh' href="#">
                            <img className='div_site_main_section_link_imagea' src={user.avatar} alt={user.first_name + 's avatar'} width={60} height={60}/>
                        </a>
                        <div className='div_site_main_section_box_text_box'> 
                ...
                <div className='div_site_main_section div_site_box_border'>
                    <div className='div_site_main_section_box'>
                        <a className='div_site_main_section_link' href="#">
                            <img className='div_site_main_section_link_imageee' src={user.avatar} alt={user.first_name + 's avatar'} width={60} height={60}/>
                        </a>
                        <div className='div_site_main_section_box_text_box'> 
                            <div className='div_site_main_section_box_texts'>
                                <div className='div_site_main_section_box_text'>
                            ...
                            <img className='image_big' src={user.avatar} alt={user.first_name + 's avatar'} width={679} height={453}/>
                        </div>
                    </div>
                    <div>
                        <ul className='div_site_main_section_box_two_list'>
