...
function DivFollow2() {
    ...
    return (
        ...
        <>
            ...
            <div className='div_follow2'>
                <div className='div_follow_box_ii'>
                ...
                <div>
                    <img className='div_follow_div_image' src={Images} alt="Images" width={405} height={178}/>
                </div>
